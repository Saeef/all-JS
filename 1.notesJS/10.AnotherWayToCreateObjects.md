...
But **NOT** all Circles need to have the **getArea() function**. It should only be created **ONCE** and 
**SHARE** among **all Circle instances**.

####..And The Way To do That Is By Using A Special Property Called :checkered_flag:  PROTOTYPE :checkered_flag: :checkered_flag:
