# <kbd>$</kbd>jQ<kbd>u</kbd>er<kbd>y</kbd>  :mega:&nbsp;&nbsp;&nbsp;  `Dr. Tony Pittarese, CIS ETSU`


#### jQuery custom mechanism for running code upon document complete load
...
- 3 alternate uses:  (depending on what we feed $)
