...
```
That :point_up_2: would not prevent default browser behavior (upon submit) :arrow_up:
...
```
:mega: however this :point_up_2: here will **return** you a **boolean**: **true** :arrow_up: :ok_hand:
or **false**.   
