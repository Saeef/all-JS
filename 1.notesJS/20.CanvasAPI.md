...
getImageData(imgData,dx,dy,[dirtyDx,dirtyDy,dirtyW,dirtyH]):   puts modified data into an image. If the dirty rectangle is supplied, then only the bits inside that rectangle are updated.           
---       
