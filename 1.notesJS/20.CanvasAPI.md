...
### drawing on a canvas requires series of steps:
...
## 2d drawing api (pretty comprehensive)
...
## canvas 2d drawing context provides some global properties that affect how object are stroked and filled.    
3 properties:
...
## drawing lines of varying widths
...
### you can save and restore canvas state (in case for whatever reasons u wanna do that)
...
### rotate transform - takes one argument
 ---
...
### functions to access Image Data
 ---
...
getImageData(imgData,dx,dy,[dirtyDx,dirtyDy,dirtyW,dirtyH]):puts modified data
into an image.If the dirty rectangle is supplied, then only the bits inside that rectangle are updated.
---
