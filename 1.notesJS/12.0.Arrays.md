...
#### here JavaScript interpreter still have to check every line, even if first one evaluates to true  :barber:
...
#### here the javascript interpreter depending on whether something is true or false; will skip blocks of code.  :barber:
