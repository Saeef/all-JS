...
<br />
<kbd>Note about flow of Execution</kbd> 
### nested statement are more efficient than single line statements.  :bomb:




#### <kbd>I Here</kbd> JavaScript interpreter still have to check every line, even if first one evaluates to true  :barber:
...
#### <kbd>II Here</kbd> the javascript interpreter depending on whether something is true or false; will skip blocks of code.  :barber: :barber:
